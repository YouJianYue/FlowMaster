...
class UserDetailResp(BaseModel):
    ...
    dept_id: Optional[Union[int, str]] = Field(None, description="部门ID", examples=[1], serialization_alias="deptId")
    dept_name: Optional[str] = Field(None, description="部门名称", examples=["Xxx科技有限公司"], serialization_alias="deptName")
    role_ids: List[Union[int, str]] = Field(default_factory=list, description="角色ID列表", examples=[[2, 3, "547888897925840927", "547888897925840928"]], serialization_alias="roleIds")
